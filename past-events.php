    ...
    <i class="fa-solid fa-xmark cancel-bars"></i>
      ...
      <div class="upcoming-events-container">
        <div class="event-card">
            <div class="event-description-pic">
                <div class="event-card-overlay"></div>
                <div class="event-card-title">Planting trees</div>
            </div>
            <div class="event-description">
                <p id="where"><b>WHERE: </b> Huruma Estate</p>
                <p id="when"><b>WHEN: </b> 12/07/2023</p>
                <p id="time"><b>TIME: </b> 10.00 AM</p>
                <p id="event-description"><b>Admin Comments:</b> The events was very successful</p>
