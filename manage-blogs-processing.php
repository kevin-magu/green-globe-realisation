...
if (isset($_POST['submit'])) {
    ...
    if (!in_array(strtolower($file_ext_1), $allowed_types) or !in_array(strtolower($file_ext_2), $allowed_types) or !in_array(strtolower($file_ext_3), $allowed_types)) {
    ...
    if (!move_uploaded_file($photo1['tmp_name'], $destination) or !move_uploaded_file($photo2['tmp_name'], $destination) or !move_uploaded_file($photo3['tmp_name'], $destination)) {
        die("Failed to upload file.");
    }
    $query = "INSERT INTO blogs(blog_title,paragraph1,paragraph2,paragraph3,photo1,photo2,photo3,author) VALUES('$blog_title','$paragraph1','$paragraph2','$paragraph3','$photo1','$photo2','$photo3','$author')";
